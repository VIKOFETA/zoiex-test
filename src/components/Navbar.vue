<template>
  ...
  >
    <a href="/"  class="navbar__icon-wrapper">
      <v-icon class="navbar__icon">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 164 35" class="navbar__icon-svg">
          <g fill-rule="evenodd" clip-rule="evenodd">
            ...
            </path><path fill="#121212" opacity="0.4" d="M24 16v-4h4M16 0v4h-4"></path>
          </g>
          <g fill="#ffffff">
